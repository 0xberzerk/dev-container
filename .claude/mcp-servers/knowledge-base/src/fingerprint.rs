...
pub fn fingerprint(params: &QueryParams) -> String {
    ...
    let json = serde_json::to_string(&normalized).expect("QueryParams must serialize");
...
mod tests {
    ...
    fn make_params(keywords: &str, tags: &[&str], categories: &[&str]) -> QueryParams {
        QueryParams {
